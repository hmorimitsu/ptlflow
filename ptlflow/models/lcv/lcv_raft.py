...
class LCV_RAFT(BaseModel):
    ...
    def __init__(self,
        ...
        self.corr_block = LearnableCorrBlock(256, self.args.corr_levels, self.args.corr_radius)
...
class LCV_RAFTSmall(LCV_RAFT):
    ...
    def __init__(self,
        ...
        self.corr_block = LearnableCorrBlock(128, self.args.corr_levels, self.args.corr_radius)
