...
class ResidualBlock(nn.Module):
    def __init__(self, in_planes, planes, norm_fn="group", stride=1, rate=(1, 1)):
        ...
        if stride == 1 and in_planes == planes:
            ...
            self.downsample = nn.Sequential(
                nn.Conv2d(
                    in_planes, planes, kernel_size=(1, 1), stride=(stride, stride)
                ),
                self.norm3,
            )
...
class BasicEncoder(nn.Module):
    def __init__(self, output_dim=128, norm_fn="batch"):
        ...
        # output convolution
        self.conv2 = nn.Conv2d(128, output_dim, kernel_size=(1, 1))
