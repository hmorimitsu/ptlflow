...
class BasicMotionEncoder(nn.Module):
    def __init__(self, dim=128, corr_channel=0):
...
class BasicUpdateBlock(nn.Module):
    def __init__(self, hdim=128, cdim=128, num_blocks=0, corr_channel=0):
        # net: hdim, inp: cdim
        super(BasicUpdateBlock, self).__init__()
        self.encoder = BasicMotionEncoder(dim=cdim, corr_channel=corr_channel)
        self.refine = []
