...
class SmallMotionEncoder(nn.Module):
    def __init__(self):
        ...
        cor_planes = 5
        self.convc1 = nn.Conv2d(cor_planes * 2, 96, 1, padding=0)
        self.convf1 = nn.Conv2d(2, 64, 5, padding=2)
        self.convf2 = nn.Conv2d(64, 32, 3, padding=1)
        self.conv = nn.Conv2d(128, 96 - 2, 3, padding=1)
...
class BasicMotionEncoder(nn.Module):
    def __init__(self):
        ...
        self.convc2 = nn.Conv2d(64, 128, 3, padding=1)
        self.convf1 = nn.Conv2d(2, 64, 5, padding=2)
        self.convf2 = nn.Conv2d(64, 64, 3, padding=1)
        self.conv = nn.Conv2d(64 + 128, 128 - 2, 3, padding=1)
...
class SmallUpdateBlock(nn.Module):
    def __init__(self, hidden_dim=96):
        ...
        self.gru = ConvGRU(hidden_dim=hidden_dim, input_dim=96 + hidden_dim)
