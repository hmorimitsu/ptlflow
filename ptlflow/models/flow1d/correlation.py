...
class Correlation1D:
    ...
    def __call__(self, coords):
        ...
        if self.x_correlation:
            ...
            delta_x = torch.stack((dx, dy), dim=-1).to(device=coords.device, dtype=coords.dtype)  # [2r+1, 2]
            ...
            dy = torch.linspace(-r, r, 2 * r + 1).to(device=coords.device, dtype=coords.dtype)
