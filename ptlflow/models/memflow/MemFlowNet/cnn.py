...
class BasicEncoder(nn.Module):
    ...
    def reset_output(self, output_dim=128):
        self.new_conv2 = nn.Conv2d(128 * self.mul, output_dim, kernel_size=1)
        with torch.no_grad():
            self.new_conv2.weight.data = self.conv2.weight.data[-output_dim:]
            self.new_conv2.bias.data = self.conv2.bias.data[-output_dim:]
        del self.conv2
