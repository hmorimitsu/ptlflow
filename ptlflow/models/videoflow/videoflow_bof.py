...
class VideoFlowBOF(BaseModel):
    ...
    def __init__(self,
        ...
        if self.args.gma == "GMA":
            ...
            self.update_block = SKUpdateBlock6_Deep_nopoolres_AllDecoder(args=self.args, hidden_dim=128)
    ...
    def add_model_specific_args(parent_parser=None):
        ...
        parser.add_argument('--gma', type=str, choices=('GMA', 'GMA-SK', 'GMA-SK2'), default='GMA-SK2')
    ...
    def forward(self, inputs, flow_init=None):
        ...
        if self.args.corr_fn == "efficient":
            ...
            corr_fn_21 = CorrBlock(fmap2, fmap1, num_levels=self.args.corr_levels, radius=self.args.corr_radius)
            corr_fn_23 = CorrBlock(fmap2, fmap3, num_levels=self.args.corr_levels, radius=self.args.corr_radius)
